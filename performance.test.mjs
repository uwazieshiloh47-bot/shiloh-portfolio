...
test("critical static assets stay within their size budgets", async () => {
  const budgets = [
    /*
      59,000, against an original 50,000. Each raise has paid for something
      specific: the Gilded design itself, the two Playfair @font-face blocks,
      and now four star planes plus their keyframes - the sky is roughly 4KB of
      this sheet on its own.
    ...
    */
    { file: "styles.css", maximumBytes: 59_000 },
